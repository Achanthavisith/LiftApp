...
const ExerciseCard = ({ data, catName, onRefresh, day }) => {
  ...
  const alert = () => {
    Alert.alert("Oops..", "Already in the workout day", [
  ...
  const addWeight = () => {
    Alert.prompt("Enter Weight", "Lbs?, Kg?", [
      {
        text: "Cancel",
  ...
  const addSet = () => {
    Alert.prompt("Enter Set", "4x10, 5x5", [
      {
        text: "Cancel",
        onPress: () => console.log("Cancel Pressed"),
        style: "cancel",
    ...
    <View>
      {route.name === "Workouts" ? (
        <>
          <TouchableOpacity
            onPress={() =>
              navigation.replace("Exercise Videos", {
                exerciseData: data,
            ...
            <View>
              <View style={styles.exerciseProp}>
                <View>
                  ...
                  <Text
                    style={{ textAlign: "center", flexWrap: "wrap", margin: 5 }}
                  >
                    Weight: {weight}
                  </Text>
        ...
        <>
          <TouchableOpacity
            onPress={() =>
              navigation.navigate("Exercise Videos", {
                exerciseData: data,
                categoryName: catName,
              })
            }
